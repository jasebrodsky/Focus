...
class DependencyGraph extends EventEmitter {
...

  {
    ...
    const resolvedPath = fs.realpathSync(filename);const sha1 = this._hasteFS.getSha1(resolvedPath); // vjpr: patch start
